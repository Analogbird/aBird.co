...
module.exports = {
	...
	expandFromMask : function (birdMask, callback) {

		return this.expandFromURL(this.serviceUrl + birdMask, callback);

	},

	statsFromMask : function (birdMask, callback) {

		var requestOptions = {
			uri: this.url + 'url/stats/?url=' + this.serviceUrl + birdMask,
			json: true,
			timeout: this.timeout
		};
